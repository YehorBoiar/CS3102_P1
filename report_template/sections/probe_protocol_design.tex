...
Sends 32 byte packets built with C \texttt{struct}.

The packet is composed of three fields:
\begin{itemize}
...
\textit{Note: The remaining 8 bytes of the 32-byte total consist of memory padding added by the C compiler to correctly align the 16-byte \texttt{timespec} structure in memory.}